<template>
    ...
    <v-navigation-drawer v-model="drawer" permanent app>
      ...
      <v-list dense>
        ...
        <div
          ...
          <v-list-item link @click="HrisDashboard()">
          ...
          <div v-if="$store.getters.valAccess(199) || $store.getters.valAccess(158) || $store.getters.valAccess(200)">
            <v-list-group prepend-icon="mdi-account" no-action color="orange">
          ...
          <div
            ...
            <v-list-group prepend-icon="mdi-account-supervisor" no-action color="orange">
              <template v-slot:activator>
                <v-list-item-content>
        ...
        <div
          ...
          <div
            ...
            <v-list-group prepend-icon="mdi-cog" no-action color="orange">
              <template v-slot:activator>
                <v-list-item-content>
  ...
  <v-sheet v-else>
    ...
    <v-navigation-drawer v-model="drawer" absolute temporary dark app>
