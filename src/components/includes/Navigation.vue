<template>
    <v-sheet v-if="hrisdata==1">
            ...
            <div class="pa-3">
                <v-card>
                  <v-toolbar style="background-color: white" height="40px">
                            <h2 class="orange--text flex text-center">SCAN ME</h2>
                    </v-toolbar>
                  <div class="pt-0 pb-3 pl-3 pr-3">
                    <v-card style="background-color: orange">
                      ...
                      <br>
                      <center>  
                            <qr-code :text="textqrcode" color="white" bg-color="orange" ></qr-code>
                      </center>
                      <br>
                      </div>
                    </v-card>
      ...
      >
        ...
        <v-list-item class="text-center">
            ...
            max-width="60"
            class="pa-7 rounded-circle d-inline-block align-self-stretch mt-2 mb-2"
            style="margin: 0px auto;"
            :src="imagepath +  profile_picture"
            ></v-img>
            <v-img
            v-else
            src="../../assets/images/circle_wirewolf.png"
        ...
        <v-list-item 
          :disabled="!$store.getters.valAccess(230)"
          @click="Profile()"
        >
          <v-list-item-content>
            <v-list-item-title style="font-size: 12px;">{{ this.$store.getters.fetchUserInfo.account_information.personal_information.firstname }} {{ this.$store.getters.fetchUserInfo.account_information.personal_information.lastname }}</v-list-item-title>
            <v-list-item-subtitle style="font-size: 12px;">{{ this.$store.getters.fetchUserInfo.account_information.email }}</v-list-item-subtitle>
        ...
        >
          ...
          <div v-if="$store.getters.valAccess(196) || $store.getters.valAccess(197) || $store.getters.valAccess(198) || $store.getters.valAccess(199) || $store.getters.valAccess(158) || $store.getters.valAccess(160) || $store.getters.valAccess(200) || $store.getters.valAccess(203) || $store.getters.valAccess(209) || $store.getters.valAccess(240) || $store.getters.valAccess(256)">
              ...
              >
                ...
                <v-list-item
                  link
                  @click="EmployeeInformation()"
                  v-if="$store.getters.valAccess(196)"
                >
            ...
            >
              ...
              <v-list-item
                link
                @click="Overtime()"
                v-if="$store.getters.valAccess(199)"
                >
              ...
              <v-list-item
                link
                @click="Tito()"
                v-if="$store.getters.valAccess(158)"
                >
              ...
              <v-list-item
                link
                @click="Timesheetconfirmation()"
                v-if="$store.getters.valAccess(200)"
              >
          ...
          <div v-if="$store.getters.valAccess(197) || $store.getters.valAccess(198) || $store.getters.valAccess(160) || $store.getters.valAccess(203) || $store.getters.valAccess(209) || $store.getters.valAccess(240) || $store.getters.valAccess(256)">
            <v-list-group
            ...
            >
              ...
              <v-list-item
                  link
                  @click="HrisListEmployee()"
                  v-if="$store.getters.valAccess(197)"
                >
              ...
              <v-list-item
                  link
                  @click="HrisForApproval()"
                  v-if="$store.getters.valAccess(198)"
                >
              ...
              <v-list-item
                link
                @click="Titoadmin()"
                v-if="$store.getters.valAccess(160)"
                >
              ...
              link
              @click="Timesheetlog()"
              v-if="$store.getters.valAccess(203)"
              >
            ...
            <v-list-item
              link
              @click="Userchecklist()"
              v-if="$store.getters.valAccess(209)"
              >
            ...
            <v-list-item
              link
              @click="ApprovalRegistration()"
              v-if="$store.getters.valAccess(240)"
              >
              <!-- <v-list-item-icon>
                <v-icon>mdi-text-box-check-outline</v-icon>
              </v-list-item-icon> -->
    ...
    <!-- Wirewolf Settings Start -->
          ...
          <v-subheader>Settings</v-subheader>  
            <v-list-item
              ...
              <v-list-item
                link
                @click="Branch()"
                :disabled="!$store.getters.valAccess(236)"
                v-if="$store.getters.valParent()"
              >
                <v-list-item-icon>
            ...
            <div v-if="$store.getters.valAccess(165) || $store.getters.valAccess(166) || $store.getters.valAccess(167) || $store.getters.valAccess(168) || $store.getters.valAccess(169) || $store.getters.valAccess(170) || $store.getters.valAccess(171) || $store.getters.valAccess(172) ||$store.getters.valAccess(173) || $store.getters.valAccess(174) || $store.getters.valAccess(175) || $store.getters.valAccess(176) || $store.getters.valAccess(177) || $store.getters.valAccess(178) || $store.getters.valAccess(179) || $store.getters.valAccess(180) || $store.getters.valAccess(181) || $store.getters.valAccess(182) || $store.getters.valAccess(183) || $store.getters.valAccess(184) || $store.getters.valAccess(185) || $store.getters.valAccess(215) || $store.getters.valAccess(245) || $store.getters.valAccess(250)">
            <v-list-group
              ...
              >
                ...
                <v-list-item 
                  link 
                  @click="Role()"
                  v-if="$store.getters.valAccess(165)"
                  >
                  <v-list-item-content>
                    <v-list-item-title>
                      Access Rights
                ...
                <v-list-item
                  link
                  @click="Division()"
                  v-if="$store.getters.valAccess(166)"
                  >
                  <v-list-item-title>
                    Division
                  </v-list-item-title>
                ...
                <v-list-item 
                      link 
                      @click="LeaveType()"
                      v-if="$store.getters.valAccess(181)"
                      >
                      <v-list-item-content>
                        <v-list-item-title>
                          Leave Type
                    ...
                    <v-list-item 
                      link 
                      @click="LeaveBalance()"
                      v-if="$store.getters.valAccess(182)"
                      >
                      <v-list-item-content>
                        <v-list-item-title>
                          Leave Credits
                    ...
                    <v-list-item 
                      link 
                      @click="Schedule()"
                      v-if="$store.getters.valAccess(183)"
                      >
                      <v-list-item-content>
                        <v-list-item-title>
                          Schedule
                    ...
                    <v-list-item 
                      link 
                      @click="Cutoff()"
                      v-if="$store.getters.valAccess(184)"
                      >
                      <v-list-item-content>
                        <v-list-item-title>
                          Cutoff
                    ...
                    <v-list-item 
                      link 
                      @click="Announcement()"
                      v-if="$store.getters.valAccess(185)"
                      >
                      <v-list-item-content>
                        <v-list-item-title>
                          Announcement
                    ...
                    <v-list-item 
                      link 
                      @click="Checklist()"
                      v-if="$store.getters.valAccess(215)"
                      >
                      <v-list-item-content>
                        <v-list-item-title>
                          Onboarding Type
                    ...
                    <v-list-item 
                      link 
                      @click="AccountabilityType()"
                      v-if="$store.getters.valAccess(245)"
                      >
                      <!-- v-if="$store.getters.valAccess(186)" -->
                      <v-list-item-content>
                        <v-list-item-title>
                    ...
                    <v-list-item 
                      link 
                      @click="AccountabilityField()"
                      v-if="$store.getters.valAccess(250)"
                      >
                      <!-- v-if="$store.getters.valAccess(186)" -->
                      <v-list-item-content>
                        <v-list-item-title>
        ...
        <v-list-item
          link
          @click="gotoposdashboard()"
          v-if="this.subtype.includes(0) && this.subtype.includes(1)"
          >
          <v-list-item-icon>
      ...
      <div v-show="true" v-if="$store.getters.fetchisChat == 0">
        <v-btn fab dark medium color="orange" fixed right bottom  @click="Chat()">
            <v-icon style="opacity: 1;" dark>mdi-chat-processing-outline</v-icon>
        </v-btn>
      </div>
      <!-- <div v-show="true" v-if="$vuetify.breakpoint.xs">
        <v-btn fab dark medium color="orange" fixed top bottom  @click="Chat()">
            <v-icon style="opacity: 1;" dark>mdi-chat-processing-outline</v-icon>
        </v-btn>
      </div> -->
    </v-sheet>
  ...
  <!-- START OF POS INVENTORY -->
    <v-sheet v-else>
      ...
      <!-- <v-footer 
        ...
        padless
        dark
        v-if="this.$store.getters.fetchUserInfo.length != 0 && this.$store.getters.getFooter"
      >
        <v-col
          class="text-center"
          cols="12"
        >
          © 2022 Wirewolf. All Rights Reserved | Design by <strong>NERDVANA</strong>
        </v-col>
      </v-footer> -->
      ...
      >
        ...
        >
            ...
            <v-list-group
              ...
              >
                ...
                <v-list-item 
                      link 
                      @click="Devices()"
                      v-if="$store.getters.valAccess(167)"
                      >
                      <v-list-item-content>
                        <v-list-item-title>
                          Devices
                ...
                <div v-if="$store.getters.valAccess(168) || $store.getters.valAccess(169) || $store.getters.valAccess(170) || $store.getters.valAccess(171) || $store.getters.valAccess(172)">
                  <v-list-group
                    no-action
                    color="orange"
                    sub-group
                  >
                    <template v-slot:activator>
                      ...
                      <v-list-item 
                        link 
                        @click="Discount()"
                        v-if="$store.getters.valAccess(168)"
                          >
                        <v-list-item-content>
                          <v-list-item-title>
                            Discount
                      ...
                      <v-list-item 
                        link 
                        @click="Department(), $store.state.snackbar.color = 'green darken-1'"
                      ...
                      <v-list-item 
                        link 
                        @click="Category(), $store.state.snackbar.color = 'green darken-1'"
                      ...
                      <v-list-item 
                        link 
                        @click="SubCategory(), $store.state.snackbar.color = 'green darken-1'"
                      ...
                      <v-list-item 
                        link  
                        @click="ProductType(), $store.state.snackbar.color = 'green darken-1'"
                ...
                <div v-if="$store.getters.valAccess(173) || $store.getters.valAccess(174) || $store.getters.valAccess(175) || $store.getters.valAccess(176) || $store.getters.valAccess(177) || $store.getters.valAccess(178) || $store.getters.valAccess(179) || $store.getters.valAccess(180)">
                  <v-list-group
                  color="orange"
                    no-action
                    sub-group
                  >
                    ...
                    <v-list-item 
                      link 
                      @click="Supplier()"
                      v-if="$store.getters.valAccess(173)"
                      >
                      <v-list-item-content>
                        <v-list-item-title>
                          Supplier
                    ...
                    <v-list-item 
                        link  
                        @click="Unit()"
                        v-if="$store.getters.valAccess(174)"
                        >
                      <v-list-item-title>
                        Unit
                      </v-list-item-title>
                    ...
                    <v-list-item 
                        link  
                        @click="Locations()"
                        v-if="$store.getters.valAccess(175)"
                        >
                      <v-list-item-title>
                        Locations
                      </v-list-item-title>
                    ...
                    <v-list-item 
                        link  
                        @click="ProductType(),$store.state.snackbar.color = 'orange'"
                    ...
                    <v-list-item 
                        link  
                        @click="Remarks()"
                        v-if="$store.getters.valAccess(177)"
                        >
                      <v-list-item-title>
                        Remarks
                      </v-list-item-title>
                    ...
                    <v-list-item 
                        link 
                        @click="Department(),$store.state.snackbar.color = 'orange'"
                      ...
                      <v-list-item 
                        link 
                        @click="Category(),$store.state.snackbar.color = 'orange'"
                      ...
                      <v-list-item 
                        link 
                        @click="SubCategory(),$store.state.snackbar.color = 'orange'"
                ...
                <!-- <div v-if="$store.getters.valAccess(181) || $store.getters.valAccess(182) || $store.getters.valAccess(183) || $store.getters.valAccess(184) || $store.getters.valAccess(185) || $store.getters.valAccess(215) || $store.getters.valAccess(186)">
                  <v-list-group
                  color="orange"
                    no-action
                    sub-group
          ...
          <div v-if="$store.getters.valAccess(187) || $store.getters.valAccess(188) || $store.getters.valAccess(262) || $store.getters.valAccess(265) || $store.getters.valAccess(268) || $store.getters.valAccess(271) || $store.getters.valAccess(278) || $store.getters.valAccess(274)">
              <v-subheader>POS</v-subheader>

              <v-list-item
                  link
                  @click="Inventory()"
                  v-if="$store.getters.valAccess(187)"
                >
                  <v-list-item-icon>
              ...
              <div v-if="$store.getters.valAccess(188) || $store.getters.valAccess(262) || $store.getters.valAccess(265) || $store.getters.valAccess(268) || $store.getters.valAccess(271) || $store.getters.valAccess(278) || $store.getters.valAccess(274)">
                <v-list-group
                color="orange"
                ...
                >
                  ...
                  <v-list-item 
                    link
                    @click="CashFundReport()"
                    v-if="$store.getters.valAccess(262)"
                  >
                    <v-list-item-content>
                      <v-list-item-title>
                        Cash Fund Report
                  ...
                  <v-list-item 
                    link
                    @click="DiscountSummaryReport()"
                    v-if="$store.getters.valAccess(265)"
                  >
                    <v-list-item-content>
                      <v-list-item-title>
                  ...
                  <v-list-item 
                    link
                    @click="ItemSummaryReport()"
                    v-if="$store.getters.valAccess(268)"
                  >
                    <v-list-item-content>
                      <v-list-item-title>
                        Top Selling Product
                  ...
                  <v-list-item 
                    link
                    @click="PaymentSummaryReport()"
                    v-if="$store.getters.valAccess(271)"
                  >
                    <v-list-item-content>
                      <v-list-item-title>
                  ...
                  <v-list-item 
                    link
                    @click="PayoutReport()"
                    v-if="$store.getters.valAccess(278)"
                  >
                    <v-list-item-content>
                      <v-list-item-title>
                        Payout Report
                  ...
                  <v-list-item 
                    link
                    @click="SalesReport()"
                    v-if="$store.getters.valAccess(188)"
                  >
                    <v-list-item-content>
                      <v-list-item-title>
                        Sales Report
                  ...
                  <v-list-item 
                    link
                    @click="VoidReport()"
                    v-if="$store.getters.valAccess(274)"
                  >
                    <v-list-item-content>
                      <v-list-item-title>
              ...
              >
                <template v-slot:activator>
                  ...
                  <v-list-item 
                      ...
                      v-if="$store.getters.valAccess(190)"
                      >
                      <!-- v-if="$store.getters.valAccess(60)" -->
                    <v-list-item-title>
                      Product Inventory
          ...
          <div v-if="$store.getters.valAccess(124) || $store.getters.valAccess(125) || $store.getters.valAccess(126) || $store.getters.valAccess(127) || $store.getters.valAccess(191)">
            <v-list-group
            color="orange"
            ...
            >
              <template v-slot:activator>
                ...
                <v-list-item 
                    link 
                    @click="StockIn()"
                    v-if="$store.getters.valAccess(124)"
                    >
                  <v-list-item-title>
                    Stock In
                  </v-list-item-title>
                ...
                <v-list-item 
                    link 
                    @click="StockOut()"
                    v-if="$store.getters.valAccess(125)"
                    >
                  <v-list-item-title>
                    Stock Out
                  </v-list-item-title>
              ...
              color="orange"
                ...
                <template v-slot:activator>
                  ...
                  <v-list-item 
                      link 
                      @click="PhysicalCount()"
                      v-if="$store.getters.valAccess(192)"
                      >
                    <v-list-item-title>
                      Physical Count List
                    </v-list-item-title>
          ...
          <div v-if="$store.getters.valAccess(193) || $store.getters.valAccess(194) || $store.getters.valAccess(195)">
            ...
            >
              <template v-slot:activator>
                ...
                <v-list-item 
                    link  
                    @click="InventoryStockCard()"
                    v-if="$store.getters.valAccess(193)"
                    >
                  <v-list-item-title>
                    Stock Card
                  </v-list-item-title>
                ...
                <v-list-item 
                    link  
                    @click="InventoryReports()"
                    v-if="$store.getters.valAccess(194)"
                    >
                  <v-list-item-title>
                    Summary Report
                  </v-list-item-title>
                ...
                <v-list-item 
                    link  
                    @click="InventoryDetailedReports()"
                    v-if="$store.getters.valAccess(195)"
                    >
                  <v-list-item-title>
                    Detailed Report
                  </v-list-item-title>
          ...
          <div v-if="$store.getters.valAccess(158) || $store.getters.valAccess(160) || $store.getters.valAccess(164)">
              ...
              <v-list-item
                link
                @click="Users()"
                v-if="$store.getters.valAccess(164)"
              >
      ...
      <div v-show="true" v-if="$store.getters.fetchisChat == 0">
        ...
        style="opacity: 1;background-color: rgba(0,0,0,0)">
          <v-col
            class="text-right"
          >
          ...
          >
            <v-icon 
            x-large
            style="opacity: 1;">mdi-chat-processing-outline</v-icon>
          </v-btn>
          </v-col>
        </v-footer>
        -->
