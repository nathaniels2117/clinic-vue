          ...
          <v-col cols="12">
              ...
              >
                  ...
                  <v-card-text>
                    ...
                    <!-- <center><h1>Terms and Conditions for WireWolf</h1></center><br><br> -->
...
<ul>
<li><b>Application</b> means the software program provided by the Company downloaded by You on any electronic device, named Wirewolf.</li>
<li><b>Application Store</b> means the digital distribution service operated and developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) in which the Application has been downloaded.</li>
...
<li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Nerdvana Corp., 1 Canley Road, Bagong Ilog, Pasig City.</li>
...
<li><b>Terms and Conditions</b> (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the Free Terms and Conditions Generator.</li>
...
"AS IS" and "AS AVAILABLE" Disclaimer</p> 
...
<ul>
<li>By email: <a href="mailto:sales@nerdvana.com.ph">sales@nerdvana.com.ph</a> </li>
...
<br>
  ...
  <script>
    ...
    export default {
      ...
      mounted(){
          this.$store.state.title = "Terms and Conditions";
      },
      methods: {
