                                ...
                                <v-row>
                                    <v-col cols="12">
                                        <v-text-field v-model="search" append-icon="mdi-magnify" placeholder="Search"
                                            hide-details color="orange" overflow solo dense
      ...
      > -->
        ...
        >
          <v-icon>mdi-view-column</v-icon>Column
                                ...
                                <template v-if="$vuetify.breakpoint.mdAndUp">
                                    <v-btn medium dark color="orange" elevation="2" @click="AddProduct()"
                                ...
                                <template v-if="$vuetify.breakpoint.smAndDown">
                                    <v-btn medium dark color="orange" elevation="2"
                                        style="padding-left: 12px;padding-right: 12px;" @click="AddProduct()"
                                        v-if="$store.getters.valAccess(102)">
            ...
            <template v-slot:selection="{ item, index }">
              ...
              <span v-if="index === 2" class="grey--text caption">(+{{ selectedHeaders.length - 2 }} others)</span>
                    ...
                    <div class="offset-md-9 col-sm-3">
                        ...
                        <br>
                        <v-data-table :headers="showHeaders" :search="search" :items="product" :page.sync="page"
                            ...
                            <template v-slot:item.name="props">
                                <v-edit-dialog :return-value.sync="props.item.name"
                                    ...
                                    <template v-slot:input>
                                        <v-text-field v-if="$store.getters.valAccess(103)" v-model="props.item.name"
                            ...
                            <template v-slot:item.description="props">
                                <v-edit-dialog :return-value.sync="props.item.description"
                                    ...
                                    <template v-slot:input>
                                        <v-text-field v-if="$store.getters.valAccess(103)"
                                            v-model="props.item.description" label="Edit" single-line></v-text-field>
                                    </template>
                                </v-edit-dialog>
                            </template>
                            <template v-slot:item.sku="props">
                                <v-edit-dialog :return-value.sync="props.item.sku"
                                    ...
                                    {{ props.item.sku }}
                                    <template v-slot:input>
                                        <v-text-field v-if="$store.getters.valAccess(103)" v-model="props.item.sku"
                                            label="Edit" single-line></v-text-field>
                                    </template>
                                </v-edit-dialog>
                            </template>
                            <template v-slot:item.barcode="props">
                                <v-edit-dialog :return-value.sync="props.item.barcode"
                                    ...
                                    {{ props.item.barcode }}
                                    <template v-slot:input>
                                        <v-text-field v-if="$store.getters.valAccess(103)" v-model="props.item.barcode"
                                            label="Edit" single-line></v-text-field>
                                    </template>
                                </v-edit-dialog>
                            </template>
                            <template v-slot:item.cost="props">
                                <v-edit-dialog :return-value.sync="props.item.cost"
                                    @save="UpdateProductInformation(props.item.id, 'cost', props.item.cost)">
                                    {{ props.item.cost }}
                                    <template v-slot:input>
                                        <v-text-field v-if="$store.getters.valAccess(103)" v-model="props.item.cost"
                                            label="Edit" single-line></v-text-field>
                                    </template>
                                </v-edit-dialog>
                            </template>
                            <template v-slot:item.selling_price="props">
                                <v-edit-dialog :return-value.sync="props.item.selling_price"
                                    @save="UpdateProductInformation(props.item.id, 'selling_price', props.item.selling_price)">
                                    {{ props.item.selling_price }}
                                    <template v-slot:input>
                                        <v-text-field v-if="$store.getters.valAccess(103)"
                                            v-model="props.item.selling_price" label="Edit" single-line></v-text-field>
                                    </template>
                                </v-edit-dialog>
                            </template>

                            <template v-slot:item.product_type="props">
                                <v-edit-dialog :return-value.sync="props.item.product_type_id"
                                    ...
                                    <template v-slot:input v-if="$store.getters.valAccess(103)">
                                        <v-combobox outlined label="Type" :items="product_type" v-model="selected"
                                            class="pt-5"></v-combobox>
                                    </template>
                                </v-edit-dialog>
                            </template>

                            <template v-slot:item.department="props">
                                <v-edit-dialog :return-value.sync="props.item.department_id"
                                    ...
                                    <template v-slot:input v-if="$store.getters.valAccess(103)">
                                        <v-combobox outlined label="Department" :items="department" v-model="selected"
                                            class="pt-5"></v-combobox>
                                    </template>
                                </v-edit-dialog>
                            </template>
                            ...
                            <template v-slot:item.category="props">
                                <v-edit-dialog :return-value.sync="props.item.category_id"
                                    ...
                                    <template v-slot:input v-if="$store.getters.valAccess(103)">
                                        <v-combobox outlined label="Category" :items="category" v-model="selected"
                                            class="pt-5"></v-combobox>
                                    </template>
                                </v-edit-dialog>
                            </template>
                            ...
                            <template v-slot:item.sub_category="props">
                                <v-edit-dialog :return-value.sync="props.item.sub_category_id"
                                    ...
                                    <template v-slot:input v-if="$store.getters.valAccess(103)">
                                        <v-combobox outlined label="Sub Category" :items="sub_category"
                                            v-model="selected" class="pt-5"></v-combobox>
                                    </template>
                                </v-edit-dialog>
                            </template>
                            ...
                            <template v-slot:item.is_vatable="props">
                                <v-edit-dialog :return-value.sync="props.item.sub_category_id">
                                    <v-chip class="ma-2" outlined color="primary" v-if="props.item.is_vatable == 1">
                                        Vatable
                                    </v-chip>
                                    ...
                                    <template v-slot:input>
                                        <v-radio-group v-model="props.item.is_vatable"
                                            @change="UpdateProductInformation(props.item.id, 'is_vatable', props.item.is_vatable)">
                                            <v-radio label="Vatable" :value="1"></v-radio>
                            ...
                            <template v-slot:item.created_by="props">
                                {{ props.item.created_info.personal_information != 0 ?
                                    props.item.created_info.personal_information.lastname + ' , ' +
                            ...
                            >
                                ...
                                <v-btn elevation="2" class="mx-2" dark small outlined color="red"
                                    v-if="$store.getters.valAccess(104)"
                                    @click="RemoveProductInformation(props.item.id, props.item)">
                                    <v-icon small @click="RemoveProductInformation(props.item.id, props.item)">
                        ...
                        <v-pagination color="orange" v-model="page" :length="pageCount"></v-pagination>
                    </v-card-text>
            ...
            <v-card>
              ...
              Save
                ...
                <v-col sm="12" md="6" offset-md="3">
                    <v-text-field v-model="product_information.name" label="Product Name" required outlined
                        color="orange"></v-text-field>
                    <v-text-field v-model="product_information.description" label="Description" required outlined
                        color="orange"></v-text-field>
                    <v-text-field v-model="product_information.sku" label="SKU" required outlined
                        color="orange"></v-text-field>
                    <v-text-field v-model="product_information.barcode" label="Barcode" required outlined
                        color="orange"></v-text-field>
                    <v-text-field v-model="product_information.cost" label="Cost" required outlined
                        color="orange"></v-text-field>
                    <v-text-field v-model="product_information.selling_price" label="Price" required outlined
                        color="orange"></v-text-field>
                    <v-combobox outlined :items="unit" label="Unit" color="orange"
                        v-model="product_information.unit_id"></v-combobox>
                    <v-combobox outlined label="Type" :items="product_type" color="orange"
                        v-model="product_information.product_type_id"></v-combobox>
                    <v-combobox outlined label="Department" color="orange" :items="department"
                        v-model="product_information.department_id"></v-combobox>
                    <v-combobox outlined label="Category" color="orange" :items="category"
                        v-model="product_information.category_id"></v-combobox>
                    <v-combobox outlined label="Sub Category" color="orange" :items="sub_category"
                        v-model="product_information.sub_category_id"></v-combobox>
                    <v-radio-group v-model="product_information.is_vatable" row>
                        <v-radio label="Vatable" color="orange" :value="1"></v-radio>
                        <v-radio label="Non-Vat" color="orange" :value="2"></v-radio>
                    </v-radio-group>
                    <center>
                        <v-col sm="12" md="12">
                            <v-btn color="orange" block outlined @click="SaveProductInformation()" id="btn-next"
                                class="btn btn-primary btn-sm p-2" style="font-size: 12px;">
                                Save
                            </v-btn>
                        </v-col>
                    </center>
