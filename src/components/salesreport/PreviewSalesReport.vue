      ...
      <v-row>
          <v-col cols="12">
              ...
              >
                  ...
                  {{this.salesreportmain[0].completed_info.employee_information.firstname}},&nbsp;{{this.salesreportmain[0].completed_info.employee_information.lastname}}
                  </div>
                  <br>
                  Receipt Number:
                  <div class="float-right">
      ...
      methods: {
          fetchitems(){
              let payload = {
                  ...
                  salesreportservices.fetchSalesReportViaID(payload, this.$store.getters.getAccessToken).then(response => {
          ...
          fetchmain(){
              let payload = {
                  ...
                  salesreportservices.fetchMainSalesReportViaID(payload, this.$store.getters.getAccessToken).then(response => {
                  if(response.data.success){
