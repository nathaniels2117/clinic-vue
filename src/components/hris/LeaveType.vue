...
<script>
  ...
  import leavetypeservices from '../services/leavetypeservices';
    ...
    export default {
      ...
      methods: {
        FetchAllLeaveType(){ // fetch all leave type
            let payload = {
        ...
        confirmUpdate(){ // update leave type
        ...
        confirmDelete(){ // delete leave type
            let payload = {
