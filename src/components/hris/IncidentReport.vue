                                    ...
                                    <!-- <v-row> -->
                                        <div class="d-flex justify-center">
                                            ...
                                            elevation="2"
                                                ...
                                                small
                                                color="orange"
                                                @click="UpdateAllIncidentReport(props.item.id, props.item)"
                                            >
                                                <v-icon
                                                small
                                                >
                                            ...
                                            elevation="2"
                                                ...
                                                small
                                                color="red"
                                                @click="DeleteIncidentReport(props.item.id, props.item.name)"
                                            >
                                                <v-icon
                                                small
                                                >
                                            ...
                                            <v-btn
                                                ...
                                                small
                                                color="orange"
                                                @click="PrintIncidentReport(props.item)"
                                            >
                                                <v-icon
                                                    small
                                                >
                                            ...
                                            <v-btn
                                                ...
                                                v-if="props.item.nte_info != null && props.item.noh_info == null && props.item.nod_info == null && props.item.nte_info.explanation != null"
                                            >
                                                <v-icon
                                                    small
                                                >
                                            ...
                                            <v-btn
                                                ...
                                                small
                                                color="orange"
                                                @click="PrintNOH(props.item)"
                                                v-if="props.item.noh_info != null"
                                            >
                                                <v-icon
                                                    small
                                                >
                                            ...
                                            <v-btn
                                                ...
                                                v-if="props.item.nte_info != null && props.item.nod_info == null && props.item.nte_info.explanation != null"
                                            >
                                                <v-icon
                                                    small
                                                >
        ...
        >
            <v-card>
                ...
                >
                    ...
                    <v-toolbar-title>Add Notice to Explain</v-toolbar-title>
                    <v-spacer></v-spacer>
                    <v-toolbar-items>
                    </v-toolbar-items>
                </v-toolbar>
                ...
                <v-col sm="12" md="6" offset-md="3" class="mt-3 text-center"> 
                    <h4>Note: Here you can add nte for employee.</h4>
                </v-col>
                                        ...
                                        <div class="pa-10">
                                            ...
                                            <v-row align="center" justify="space-around">
                                                ...
                                                <v-btn
                                                    ...
                                                    small
                                                    color="orange"
                                                    @click="PrintIncidentReport(itemir)"
                                                >
                                                    <v-icon
                                                        small
                                                    >
...
export default {
    ...
    methods: {
        FetchAllIncidentReport(){ // fetch all incident report
            let payload = {
                parent_id: this.$store.getters.getParentID
            };
            incidentreportservices.FetchAllIncidentReport(payload, this.$store.getters.getAccessToken).then(response => {
        ...
        PrintIncidentReport(item){  // print incident report
        ...
        PrintNTE(item){  // print notice to explain
            console.log(item)
            localStorage.setItem('is_hris', 0)
        ...
        PrintNOH(item){ // print notice of hearing
            console.log(item)
            localStorage.setItem('is_hris', 0)
            localStorage.setItem('noh_id', item.noh_info.id)
            localStorage.setItem('noh', item.id)
            localStorage.setItem('forprintpreviewnoh', 0)
        ...
        PrintNOD(item){ // print notice of dismissal
            console.log(item)
            localStorage.setItem('is_hris', 0)
            localStorage.setItem('nod', item.id)
            localStorage.setItem('nod_id', item.nod_info.id)
            localStorage.setItem('forprintpreviewnod', 0)
            window.open("/printnod","_blank")
        },
        // OpenStepper(itemir){
        //     this.step = 1
        //     this.stepperfullscreendialog = true;
        //     this.itemir = itemir;
        // },
        // Stepper(step){
        //     this.step = step
